class Vehicle:
    ...
    def __str__(car):
        return '{}, {}, {}, {}'.format(car.make,
                                       car.model,
                                       car.year,
                                       )

    def __repr__(car):
        return '{} {}'.format(car.color, car.model)
...
class ParkingLot:
    ...
    def create_space_numbers(self):
        lot_numbers = {} #this creates an empty dictionary
        for space_number in range(1, self.spaces + 1): #takes self.spaces and sets a range starting at 1 up to the defined number of spaces + 1
            lot_numbers['space_' + str(space_number)] = None #this returns the list of spaces which equal blank/empty
        return lot_numbers #shows the empty spaces
